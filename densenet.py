    ...
    with tf.variable_scope(scope, 'DenseNet', [images, num_classes]):
        with slim.arg_scope(bn_drp_scope(is_training=is_training,
			...
			#Before entering the first dense block, 
  			#a convolution with 16 (or twice the growth rate for DenseNet-BC) output channels 
            ...
            current = end_points['block1'] = block(current, layer, growth, scope='lblock1')
            ...
            current = end_points['block2'] = block(current, layer, growth, scope='lblock2')
            ...
            current = end_points['block3'] = block(current, layer, growth, scope='myblock3')
            ...
            current = end_points['block4'] = block(current, layer, growth, scope='lblock3')	
